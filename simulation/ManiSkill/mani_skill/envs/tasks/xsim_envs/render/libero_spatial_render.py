...
from mani_skill.envs.tasks.xsim_envs.libero_spatial import LiberoSpatialEnv
...
@register_env("Libero-Spatial-Eval", max_episode_steps=100)
class LiberoSpatialEvalEnv(LiberoSpatialEnv):
    """
    Evaluation version of LiberoSpatialEnv that terminates episodes when success is reached.

    This environment extends the refactored LiberoSpatialEnv with lighting and camera randomization
